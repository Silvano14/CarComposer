...
import { ADD_ACCESSORY, NEXT_PAGE, PREVIOUS_PAGE, REMOVE_ACCESSORY, UPDATE_COLOR, UPDATE_MODEL, UPDATE_PAGE, UPDATE_PRICE } from '../actions/action';
...
export const initialState: DefaultState = { pageVisible: Pages.Models, product: { accessories: [], price: 0, color: Color.White | Color.GreyMetallic } };
